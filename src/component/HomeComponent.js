       ...
       <div className="col-12 col-md-5 m-1 mt-4">
        <Card style={{paddingBottom:"43px"}}>
         <CardBody className="card-body-custom">
          ...
          <CardText><b className="btn btn-primary mt-3 font-custom">Reservation</b> <b className="btn btn-success mt-3 font-custom">Reservation</b></CardText>
         </CardBody>
        </Card>
       </div> 
    );
...
const FeaturedDish=({promo})=>{
    return(
        <div className="col-12 col-md-5 m-1 mt-4">
         ...
         <CardImgOverlay style={{color:"#5eaaa8",fontSize:"25px"}}><b className="font-custom">{promo.name}</b></CardImgOverlay>
        </Card>
        </div>
    );
}
